document.addEventListener('DOMContentLoaded', () =>
{
    ...
    chatForm.addEventListener('submit', async e =>
    {
        ...
        // Add AI loading spinner message
        const aiLoadingMsg = document.createElement('div');
        aiLoadingMsg.className = 'message ai ai-loading';
        aiLoadingMsg.innerHTML = `<span class="inline-spinner"></span> <span style="color:#888;">AI is typing...</span>`;
        conversationBox.appendChild(aiLoadingMsg);
        scrollToBottom();
